...
//     bgView.center = self.center;
    ...
    [_textFiled2 addTarget:self action:@selector(textFieldEditChanged:) forControlEvents:UIControlEventEditingChanged];
    ...
    _textFiled1.enabled=NO;
    _textFiled1.tag = 199010;
...

{
    ...
    float ZongEstr=[_changeStr floatValue ]+[sss floatValue]+[LiXiLab2.text floatValue];
    _textFiled1.text=[NSString stringWithFormat:@"%.2lf",ZongEstr];
